...
struct sRecordInfo
{
  ...
  uint8_t TypeLength;
	...
	struct sRecordInfo *SPRecordStructAdd[SP_MAX_RECORD]; /*in case of smart poster array to store add of other sRecordInfo struct */
...
uint16_t NDEF_IdentifyNDEF ( struct sRecordInfo *pRecordStruct, uint8_t* pNDEF );
